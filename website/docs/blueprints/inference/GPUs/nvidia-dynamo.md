...
:::info Version and Configuration (v0.8.0)
**Current Version:** This blueprint is pinned to Dynamo **v0.8.0**. Upstream version **v0.8.1** is available—see `DYNAMO_UPSTREAM_PARITY.md` in the repository root for the version delta and upgrade strategy.

**Default Features in v0.8.0:**
...
- **Grove/Kai Scheduler (Disabled):** Multi-node orchestration via Grove and Kai Scheduler is disabled pending EKS validation. Use LeaderWorkerSet (LWS) for multi-node tensor parallelism.

**Blueprint Layout (v0.8.0+):** Examples are now organized by purpose:
...
- **No Build Required**: Uses official [NGC container images](https://catalog.ngc.nvidia.com/orgs/nvidia/teams/ai-dynamo/collections/ai-dynamo) (v0.8.0)
...
**Supported Versions:**
- **v0.8.0**: Current stable release (default), upstream v0.8.1 available
...
- [vLLM Runtime Container](https://catalog.ngc.nvidia.com/orgs/nvidia/teams/ai-dynamo/containers/vllm-runtime): vLLM backend (v0.8.0)
- [SGLang Runtime Container](https://catalog.ngc.nvidia.com/orgs/nvidia/teams/ai-dynamo/containers/sglang-runtime): SGLang backend (v0.8.0)
- [TensorRT-LLM Runtime Container](https://catalog.ngc.nvidia.com/orgs/nvidia/teams/ai-dynamo/containers/trtllm-runtime): TRT-LLM backend (v0.8.0)
