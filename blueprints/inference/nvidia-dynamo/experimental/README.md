# experimental/: Heavy DGDR & Specialized
...
:::warning
**Grove/KAI orchestration is currently disabled** in this blueprint due to upstream stability issues on AI-on-EKS Clusters.

Multi-node examples relying on Grove/KAI have been removed.
**LeaderWorkerSet (LWS)** is the supported orchestrator for multi-node workloads in Dynamo v0.8.0, but specific experimental multi-node configurations are temporarily unavailable pending validation.
