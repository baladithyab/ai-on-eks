...
Unlike Core/Standard/Advanced tiers which focus on **Dynamo features**, this category focuses on **model capabilities** and **model family diversity**.

| Tier | Focus | Model Selection |
|------|-------|-----------------|
| 01-core | Dynamo features | Standardized (Qwen3-0.6B) |
| 02-standard | 8B benchmarks | Standardized (Qwen3-8B) |
| 03-advanced | Large-scale production | Feature-specific |
| **05-model-showcase** | **Model families** | **Diverse models** |
...
# Test inference
./test.sh 05-model-showcase/deepseek
```
...
- **01-core:** Uses `Qwen/Qwen3-0.6B` for all feature demos
- **02-standard:** Uses `Qwen/Qwen3-8B` for 8B benchmarks
