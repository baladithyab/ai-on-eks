...
Dynamo v0.8.0 deprecates embedded autoscaling. Use standard Kubernetes approaches:
...
Model-Express is the default mechanism for efficient model loading in Dynamo v0.8.0. It automates the retrieval and caching of model weights.
